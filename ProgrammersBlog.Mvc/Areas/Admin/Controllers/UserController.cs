...
using LionsTimes.Shared.Utilities.Extensions;
...
using LionsTimes.Mvc.Areas.Admin.Models;
using LionsTimes.Mvc.Helpers.Abstract;

namespace LionsTimes.Mvc.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class UserController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var userAddAjaxModel = JsonSerializer.Serialize(new UserAddAjaxViewModel
                    {
                        ...
                        {
                            ResultStatus = ResultStatus.Success,
                            Message = $"{user.UserName} user was successfully added.",
                            User = user
                        },
        ...
        public async Task<JsonResult> Delete(int userId)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    ResultStatus = ResultStatus.Success,
                    Message = $"{user.UserName} user was successfully deleted.",
                    User = user
                });
            ...
            else
            {
                ...
                var deletedUserErrorModel = JsonSerializer.Serialize(new UserDto
                {
                    ...
                    Message =
                        $" An error occured while deleting user {user.UserName}\n{errorMessages}",
                    User = user
                });
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userUpdateViewModel = JsonSerializer.Serialize(new UserUpdateAjaxViewModel
                    {
                        ...
                        {
                            ResultStatus = ResultStatus.Success,
                            Message = $"{updatedUser.UserName} user was successfully updated.",
                            User = updatedUser
                        },
        ...
        public async Task<ViewResult> ChangeDetails(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData.Add("SuccessMessage", $"{updatedUser.UserName} user was successfully updated.");
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isVerified)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        TempData.Add("SuccessMessage", $"Password successfully changed.");
                        return View();
                    }
                    else
                    {
                ...
                {
                    ModelState.AddModelError("","Please verify your old and new passwords.");
                    return View(userPasswordChangeDto);
                }
            }
            else

...
namespace LionsTimes.Mvc.Helpers.Concrete
{
    public class ImageHelper:IImageHelper
    {
        ...
        public async Task<IDataResult<ImageUploadedDto>> UploadUserImage(string userName, IFormFile pictureFile, string folderName="userImages")
        {
            ...
            return new DataResult<ImageUploadedDto>(ResultStatus.Success,$"{userName} 's picture has been successfully uploaded.",new ImageUploadedDto
            {
        ...
        public IDataResult<ImageDeletedDto> Delete(string pictureName)
        {
            ...
            {
                return new DataResult<ImageDeletedDto>(ResultStatus.Error,$"Could not find picture.",null);
            }
        }
    }
}
